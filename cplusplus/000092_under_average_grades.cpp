 ...
 *
 * Input:
 * Mỗi điểm trong danh sách là một số thực n(0≤n≤10) nằm trên 1 hàng. Input sẽ kết thúc ở dòng có số -1 (Số -1 sẽ không được tính vào
 * danh sách liên kết).
 * 
 ...
 * Explanation:
 * Ví dụ 1:
 * Điểm dưới trung bình là điểm nhỏ hơn 5,0. Vậy ta có 3 kết quả điểm dưới trung bình là 2.5, 3, 0.
 **/
