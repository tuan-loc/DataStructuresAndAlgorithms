...
/**
 * Cho số nguyên dương n, kiểm tra số n có phải là số đối xứng hay không. Biết rằng số đối xứng là số mà đọc từ trái sang phải (không bao
 * gồm các chữ số 0 vô nghĩa ở đầu) hay từ phải sang trái đều như nhau.
 * 
