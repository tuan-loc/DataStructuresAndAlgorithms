...
/**
 * Cho đồ thị có hướng được biểu diễn bằng danh sách cạnh (edge list). Giữa 2 đỉnh có thể có nhiều hơn 1 cạnh với các trọng số khác nhau.
 * Hãy tính tổng trọng số các cạnh có trọng số nhỏ nhất.
 *
 * Input:
