...
/**
 * Biết rằng tai nạn sẽ xảy ra nếu xe đụng phải người đi bộ. Do đó chúng ta cần tránh sao cho đèn báo hiệu dành cho người đi bộ của phần
 * ngã tư bất kỳ không được bật lên cùng lúc với đèn xanh của làn xe có thể chạy qua phần ngã tư đó.
 * 
 ...
 * Explanation:
 * Ví dụ 1:
 * Tai nạn có thể xảy ra vì xe ở phần ngã tư thứ nhất có thể đụng phải người đi bộ ở phần ngã tư thứ nhất và thứ tư, đồng thời xe ở phần ngã
 * tư thứ hai và ba có thể đụng phải người đi bộ ở phần ngã tư thứ tư.
