...
/**
 * Bobo hiện tại đang làm nhân viên marketing cho công ty PaPa, nhân dịp cuối năm công ty có tổ chức sự kiện tặng quà tri ân cho khách
 * hàng nhưng mỗi khách hàng muốn nhận được quà phải điền địa chỉ email của mình vào phiếu thông tin. Tuy nhiên có một số khách hàng
 * muốn nhận được nhiều quà hơn nên đã ghi “khống” địa chỉ email nhiều lần. Công ty giao nhiệm vụ cho Bobo hãy lọc ra các địa chỉ email
 * không hợp lệ, tuy nhiên có tới hơn 1000 phiếu thông tin để lọc. Nghe nói các học viên Big-O rất giỏi về thuật toán nên Bobo nhờ các bạn
 * học viên hãy viết giùm cho Bobo một chương trình có thể lọc ra các email không hợp lệ.
 * 
 * Một email hợp lệ là:
