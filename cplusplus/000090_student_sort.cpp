...
/**
 * Cho N sinh viên khác nhau, mỗi sinh viên sẽ gồm mã số sinh viên và điểm của mình. Hãy tìm k sinh viên có điểm cao nhất trong N sinh
 * viên này.
 *
 * Input:
 * Dòng thứ nhất gồm N (1≤N≤1000) là số lượng sinh viên và k (1≤k≤N) là số sinh viên cần lấy điểm cao nhất cách nhau bởi một
 * khoảng trắng.
 * 
