 ...
 *
 * Output:
 * Một dòng duy nhất là tích của các số nguyên tố nằm trên đường chéo phụ của ma trận. Trường hợp không có số nguyên tố nào trên đường
 * chéo thì in ra 1.
 * 
 ...
 * 
 * Explanation:
 * Ví dụ 1: Đường chéo phụ có số 3 là số nguyên tố. Vậy tích là 3.
 **/
