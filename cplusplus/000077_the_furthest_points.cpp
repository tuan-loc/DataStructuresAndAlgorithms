...
/**
 * Cho bạn một điểm M(x,y) và N điểm khác trong mặt phảng Oxy, hãy tìm những điểm xa nhất so với điểm M. Biết công thức tính
 * khoảng cách giữa hai điểm A(x,y) và B(z,t) là:
 * 
 ...
 * 
 * Ví dụ 2:
 * Trong 3 điểm đã cho ta có điểm (1, 2) và (-1,-2) đều xa nhất và có cùng khoảng cách với điểm (0,0). Nhưng điểm (-1,-2) xuất hiện đầu tiên
 * trong danh sách được cho.
 **/
