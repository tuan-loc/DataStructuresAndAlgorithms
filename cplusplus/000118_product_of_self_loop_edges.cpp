...
/**
 * Cho đồ thị có hướng được biểu diễn bằng danh sách cạnh (edge list). Trong đồ thị có các cạnh khuyên. Hãy đếm số lượng khuyên và tính
 * tích trọng số các cạnh khuyên đó.
 *
 * Input:
