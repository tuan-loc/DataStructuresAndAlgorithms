...
/**
 * Petya đang học tại một ngôi trường và cậu rất yêu thích toán học. Lớp cậu đang học các biểu thức toán học. Vào buổi học cuối cùng, cô
 * giáo viết ba số nguyên dương a,b,c lên chiếc bảng đen. Việc cậu cần làm là chèn các dấu '+' và '*', và cả những dấu ngoặc giữa các số để
 * giá trị biểu thức thu được là lớn nhất có thể.
 * 
 ...
 * (1+2)×3=9
 * 
 * Lưu ý là bạn chỉ có thể chèn các toán tử vào giữa a và b, và giữa b và c, tức là bạn không được hoán đổi vị trí các con số. Cụ thể là trong ví
 * dụ trên bạn không thể tạo được biểu thức (1+3)×2.
 * 
