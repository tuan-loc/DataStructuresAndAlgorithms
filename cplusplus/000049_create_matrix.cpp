...
/**
 * Cho hai giá trị đầu tiên của ma trận và một số p, bạn hãy tạo ra một ma trận từ 2 số ban đầu, biết giá trị sau bằng tổng 2 giá trị trước cộng
 * lại rồi lấy phần dư khi chia cho p, tính từ trái sang phải và từ trên xuống dưới.
 * 
