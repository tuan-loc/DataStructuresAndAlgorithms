...
/**
 * Cho đồ thị có hướng có trọng số, được biểu diễn bằng danh sách cạnh (edge list). Hãy liệt kê danh sách K cạnh có trọng số nhỏ nhất. Liệt
 * kê theo thứ tự giảm dần của trọng số.
 *
 * Input:
