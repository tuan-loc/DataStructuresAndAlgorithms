...
/**
 * Cho danh sách liên kết đơn các ngày gồm 3 thông tin {ngày, tháng, năm}. Tìm ngày lớn nhất trong danh sách đã cho. Ghi chú: ngày lớn
 * nhất là ngày có khoảng cách lớn nhất với ngày 1/1/1
 *
 * Input:
