...
/**
 * Cho lần lượt các số nguyên dương, hãy tạo danh sách liên kết đơn từ các số đó và đếm xem có bao nhiêu số nguyên tố trong danh sách
 * liên kết đơn mới tạo.
 *
 * Input:
 ...
 * Explanation:
 * Ví dụ 1:
 * Trong danh sách liên kết đã cho ta có 3 số nguyên tố lần lượt là: 5, 2, 3.
 **/
