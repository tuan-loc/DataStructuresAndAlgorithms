...
/**
 * Đếm số lượng các phần tử giá trị "Hoàng Hậu" trên ma trận vuông. Một giá trị được gọi là Hoàng Hậu khi nó là giá trị lớn nhất trên dòng,
 * trên cột và hai đường chéo đi qua nó. Mô tả:
 * (/images/000047_count_queens_01.png)
 *
 * Input:Dòng đầu tiên chứa số N là số dòng và số cột của ma trận (N≤100).
 * 
