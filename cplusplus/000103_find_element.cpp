...
/**
 * Cho một mảng các số nguyên theo thứ tự tăng dần có N phần tử (N≤10^5) và một số nguyên x (∣x∣≤10^​9), tìm vị trí xuất hiện của x
 * trong mảng (vị trí bắt đầu từ 1).
 *
 * Input:
