 ...
 *
 * Output:
 * Một dòng duy nhất là hai số nguyên a và b cách nhau bởi khoảng trắng, với a,b là tử và mẫu của tổng hai phân số từ dữ liệu vào.
 *
 * Example 1:
 * Input:
 * 1 3
 ...
 * Explanation:
 * Ví dụ 1:
 * Phân số đầu là 1/3 và phân số thứ hai là 1/3. Vậy tổng 2 phân số là 2/3
 **/
