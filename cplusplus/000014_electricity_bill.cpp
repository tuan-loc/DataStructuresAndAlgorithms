...
/**
 * "Ding!!! Dong!!! Ding!!! Dong!!!" - chuông cửa nhà bạn lại vang lên không ngừng vào ngày này mỗi tháng vì nhân viên thu tiền điện lại đến
 * tìm bạn. Bạn được xem hóa đơn tiền điện mình dùng trong tháng trước nhưng băn khoăn không biết rằng con số này có được tính chính
 * xác theo quy định hay không.
 * 
 ...
 * 
 * Số đầu tiên là chỉ số điện đầu tháng truớc, số tiếp theo là chỉ số điện đầu tháng này của bạn. (Bạn được đảm bảo là chỉ số điện tháng sau
 * luôn không bé hơn chỉ số điện tháng trước và các chỉ số điện có giá trị không quá 10^6).
 *
 * Output:
 ...
 * Explanation:
 * Ví dụ 1:
 * Tháng trước bạn sử dụng 48 kWh điện (số mới 168 – số cũ 120). Tra theo bảng trên thì bạn chỉ sử dụng điện ở bậc 1 nên tiền điện của bạn
 * là 48×1484=71232 (VND). Vậy tiền phải trả là 71232+71232×10%=78355.2 (VND), bạn chỉ cần in ra 78355.
 * 
 * Ví dụ 2:
 ...
 * 
 * Vậy chi phí điện sinh hoạt của bạn là 74200+76650+178600+6726=336176 (VND). Và tổng số tiền bạn cần trả là
 * 336176+336176×10%=369793.6, vì chỉ lấy phần nguyên nên kết qua cần in ra là 369793.
 **/
