 ...
 *
 * Input:
 * Gồm nhiều dòng, mỗi dòng chứa một số nguyên duy nhất là điểm của từng học sinh trong lớp (Số dòng không quá 10000 dòng và luôn ít
 * nhất có điểm của một học sinh, dữ liệu đảm bảo số điểm không nhỏ hơn 0 và không lớn hơn 10). Kết thúc các dòng dữ liệu điểm là một
 * dòng chứa số −1.
 *
 * Output:
