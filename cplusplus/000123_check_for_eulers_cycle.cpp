...
/**
 * Cho ma trận kề của đồ thị vô hướng liên thông, hãy kiểm tra đồ thị có phải là chu trình Euler hay không. Nếu có in ra “YES” ngược lại in ra
 * “NO”.
 * 
 ...
 * 
 * Thành phố Königsberg, khi ấy thuộc Vương quốc Phổ nằm bên bờ sông Pregel, trong đó có hai đảo lớn được nối với nhau và với đất liền
 * bằng 7 cây cầu. Bài toán đặt ra là liệu có con đường nào để đi liền một mạch mà mỗi lần chỉ đi qua đúng một cầu và quay trở lại điểm xuất
 * phát. Câu trả lời là không tồn tại con đường như vậy, hay không tồn tại một đường đi Euler. Lời giải này được coi như là định lý đầu tiên
 * trong lĩnh vực lý thuyết đồ thị, đặc biệt là lý thuyết đồ thị phẳng.
 * 
 ...
 * 
 * Mặc định C​i,i=0 với mọi i (0≤i<N).
 * 
