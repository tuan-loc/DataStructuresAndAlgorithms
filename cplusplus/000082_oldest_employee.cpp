 ...
 *
 * Output:
 * Một dòng duy nhất bao gồm mã số, tên và năm sinh của nhân viên lớn tuổi nhất. Nếu nhiều nhân viên có tuổi lớn nhất chỉ cần in ra dữ liệu
 * của người có mã số nhỏ nhất.
 *
 * Example 1:
 * Input:
 * 3
